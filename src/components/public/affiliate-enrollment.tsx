                            ...
                            <FormControl>
                                ...
                                {PAYMENT_METHODS.map((method) => (
                                    <FormItem key={method.id} className="relative">
                                        ...
                                        >
                                            <Image src={method.logoSrc} alt={method.label} width={48} height={48} className="mb-2" />
                ...
                <div className="p-4 border rounded-lg bg-background/50">
                     <h4 className="font-semibold text-lg">Método de Pago Seleccionado</h4>
                      <div className="flex items-center gap-4 mt-2">
                        <Image src={selectedMethod.logoSrc} alt={selectedMethod.label} width={40} height={40} />
                        <div>
                            <p className="font-semibold">{selectedMethod.label}</p>
                            <p className="text-sm text-muted-foreground">{selectedMethod.accountInfo}</p>
                        </div>
                    </div>
                </div>
            )}
